...
// which are addressable buckets of data.
...
module.exports = rc.createConductor({
    ...
    handlers: [
        [
            ...
            // defined on the 'basic' key of the models config.
            // models have their own lifecycle methods.
            ...
            function render(req, res, next) {
                ...
                // or we can pass no model names, and get back an array of all models
